...
from Romeo.helper.constants import MEMES
...
@Client.on_message(filters.command("smoon", ".") & filters.me)
async def smoondf(client: Client, message: Message):
    if message.forward_from:
        return
...
@Client.on_message(filters.command("tmoon", ".") & filters.me)
async def tmoondf(client: Client, message: Message):
    if message.forward_from:
        return
    animation_interval = 0.2
...
@Client.on_message(filters.command("loveu", ".") & filters.me)
async def tmoondf(client: Client, message: Message):
    if message.forward_from:
        return
    animation_interval = 0.5
    animation_ttl = range(70)
    await message.edit("LoveU..")
    animation_chars = [
        "😀",
        "👩‍🎨",
        "😁",
    ...
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await message.edit(animation_chars[i % 35])


@Client.on_message(filters.command("train", ".") & filters.me)
async def tmoondf(client: Client, message: Message):
    if message.forward_from:
        return
    animation_interval = 0.2
    animation_ttl = range(30)
    await message.edit("Rape..")
    animation_chars = [
         "**r**",
        "**ra**",
        "**rap**",
    ...
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await message.edit(animation_chars[i % 30])


@Client.on_message(filters.command("thinking", ".") & filters.me)
async def tmoondf(client: Client, message: Message):
    if message.forward_from:
        return
    animation_interval = 0.5
    ...
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await message.edit(animation_chars[i % 36])
...
async def gkahgagw(client: Client, message: Message):
    ...
    animation_chars = [
        ...
        "⬜⬜⬛⬜⬜\n⬜⬛⬜⬜⬜\n🔴⬜⬜⬜⬜",
        "🔴⬛⬛⬜⬜\n⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜",
        "⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜\n⬜  [KING IS BEST](https://github.com/vbtsvillian) ⬜\n⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜",
    ]
    if message.forward_from:
        return
...
@Client.on_message(filters.command(["f4ck", "fucek"], ".") & filters.me)
...
@Client.on_message(filters.command(["villian"], ".") & filters.me)
async def vilentw(client: Client, message: Message):
    e = await edit_or_reply(message, "😀")
    await e.edit("😃")
    await e.edit("😄")
    await e.edit("😁")
    ...
    await e.edit("😩")
    await e.edit("😫")
    await e.edit("VILLIAN")


@Client.on_message(filters.command(["villian2"], ".") & filters.me)
async def animete(client: Client, message: Message):
    e = await edit_or_reply(message, "🔥")
    await e.edit("I'm a")
    await e.edit("..murderer☠️")
    await e.edit("....I killed  the person👿")
    await e.edit("🩸")
    await e.edit("that I used to be..")
    await e.edit("💀")


@Client.on_message(filters.command(["angel"], ".") & filters.me)
async def animenig(client: Client, message: Message):
    e = await edit_or_reply(message, "They")
    await e.edit("..broke the")
    await e.edit("❤️‍🩹")
    await e.edit("wrong parts..")
    await e.edit("of me..")
    await e.edit("💥")
    await e.edit("They")
    await e.edit("broke")
...
@Client.on_message(filters.command(["villian3"], ".") & filters.me)
async def animeer(client: Client, message: Message):
    e = await edit_or_reply(message, "💥💀")
    await e.edit("SOMETIMES THE WORLD DOESN'T")
    await e.edit("NEED ANOTHER HERO")
    await e.edit("👁️‍🗨️💭")
    await e.edit("SOMETIMES")
    await e.edit("WHAT IT NEEDS☠️")
    await e.edit("IS A MONSTER")
    await e.edit("👿")


@Client.on_message(filters.command(["fire"], ".") & filters.me)
async def animese(client: Client, message: Message):
    e = await edit_or_reply(message, "🔥🔥")
    await e.edit("KEEP THE FIRE")
    await e.edit("INSIDE YOU BURNING")
    await e.edit("❤️‍🔥")
    await e.edit("BECAUSE")
    await e.edit("WHEN IT UNLEASHES")
    await e.edit("🩸😈")
    await e.edit("YOU'LL BECOME")
    await e.edit("UNBEATABLE!")
    await e.edit("☠️")
    await e.edit("💥")


@Client.on_message(filters.command(["devil"], ".") & filters.me)
async def animesix(client: Client, message: Message):
    e = await edit_or_reply(message, "TREAT ME")
    await e.edit("LIKE A KING")
    await e.edit("👑")
    await e.edit("AND I'LL TREAT YOU")
    await e.edit("LIKE A QUEEN")
    await e.edit("👸👸")
    await e.edit("💸💸💸💸")
    await e.edit("but if you treat me")
    await e.edit("like a game,")
    await e.edit("🎮")
    await e.edit("I will show you")
    await e.edit("how it's played")
    await e.edit("😈😈")
    await e.edit("🔥🔥🔥🔥")


@Client.on_message(filters.command(["death"], ".") & filters.me)
async def animfid(client: Client, message: Message):
    e = await edit_or_reply(message, "Death")
    await e.edit("⚰️")
    await e.edit("IS NOT THE GREATEST")
    await e.edit("LOSS IN OUR LIFE ")
    await e.edit("💬")
    await e.edit("THE GREATEST LOSS IS")
    await e.edit("WHAT DIES INSIDE")
    await e.edit("LOVE YOU 💝💖💘")
    await e.edit("☠️")
    await e.edit("US WHILE WE LIVE")
    await e.edit("😈")


@Client.on_message(filters.command(["villian4"], ".") & filters.me)
async def animefu(client: Client, message: Message):
    e = await edit_or_reply(message, "🗯️🦴")
    await e.edit("My feelings")
    await e.edit("seemed")
    await e.edit("false to you,")
    await e.edit("🩸")
    await e.edit("now I have killed")
    await e.edit("my feelings, 🔥💥")
    await e.edit("just look at me,")
    await e.edit("🖤")
    await e.edit("I have become")
    await e.edit("a Demon😈")
    await e.edit("😈")


@Client.on_message(filters.command(["villian5"], ".") & filters.me)
async def animthrdf(client: Client, message: Message):
    e = await edit_or_reply(message, "🔥")
    await e.edit("You")
    await e.edit("Can't")
    await e.edit("Destroy")
    await e.edit("Me")
    await e.edit("👿")
    await e.edit("When")
    await e.edit("I")
    await e.edit("Have")
    await e.edit("Already")
    await e.edit("💥💥")
    await e.edit("Destroy")
    await e.edit("Myself.")
    await e.edit("💬🩸")
...
@Client.on_message(filters.command(["villian6"], ".") & filters.me)
async def animtwdf(client: Client, message: Message):
    e = await edit_or_reply(message, "THERE IS ")
    await e.edit("🔥🔥")
    await e.edit("BEAUTY")
    await e.edit("IS EVERYTHING")
    await e.edit("🖤🖤💬")
    await e.edit("Even The SILENCE")
    await e.edit("🩸")
    await e.edit("AND DARKNESS")
    await e.edit("👁️‍🗨️💸💭")


@Client.on_message(filters.command(["villian7"], ".") & filters.me)
async def animedf(client: Client, message: Message):
    e = await edit_or_reply(message, "EVERY")
    await e.edit("...WEAK")
    await e.edit("PERSON")
    await e.edit("💬")
    await e.edit("CAN CHANGE")
    await e.edit("INTO THE STRONGEST")
    await e.edit("MONSTER")


@Client.on_message(filters.command(["vilen"], ".") & filters.me)
async def villdfone(client: Client, message: Message):
    e = await edit_or_reply(message, "We both know")
    await e.edit("I wasn't the")
    await e.edit("Villain of")
    await e.edit("Our story.")
    await e.edit("👁️‍🗨️")
    await e.edit("But if you")
    await e.edit("want to play")
    await e.edit("victim now,")
    await e.edit("I'll be just")
    await e.edit("the monster")
    await e.edit("you need.")


@Client.on_message(filters.command(["villian8"], ".") & filters.me)
async def villiafd(client: Client, message: Message):
    e = await edit_or_reply(message, "If")
    await e.edit("you")
    await e.edit("want")
    await e.edit("me")
    await e.edit("to")
    await e.edit("control")
    await e.edit("my")
    await e.edit("temper")
    await e.edit("then")
    await e.edit("you")
...
@Client.on_message(filters.command(["attitude1"], ".") & filters.me)
async def attifourdf(client: Client, message: Message):
    e = await edit_or_reply(message, "Beta")
    await e.edit("Baap")
    await e.edit("Ke")
    await e.edit("Samne")
    await e.edit("Aiyashi")
    await e.edit("💸💸")
    await e.edit("Aur")
    await e.edit("Hamare")
    await e.edit("Samne")
    await e.edit("Badmashi")
    await e.edit("😈😈")
    await e.edit("Bhul")
    await e.edit("Kar")
    await e.edit("Bhi")
...
@Client.on_message(filters.command(["attitude2"], ".") & filters.me)
async def attithreedf(client: Client, message: Message):
    e = await edit_or_reply(message, "Sote")
    await e.edit("hua")
    await e.edit("sher")
    await e.edit("ko")
    await e.edit("mat")
...
@Client.on_message(filters.command(["attitude3"], ".") & filters.me)
async def attitudedf(client: Client, message: Message):
    e = await edit_or_reply(message, "Un")
    await e.edit("bato")
    await e.edit("par")
    await e.edit("dhyan")
    await e.edit("mat")
...
@Client.on_message(filters.command(["attitude4"], ".") & filters.me)
async def attitwodf(client: Client, message: Message):
    e = await edit_or_reply(message, "Teri")
    await e.edit("Akad")
    await e.edit("Mere")
    await e.edit("Qadmo")
    await e.edit("Ki")
...
@Client.on_message(filters.command(["vbtsvillian"], ".") & filters.me)
async def vbtsvilliandf(client: Client, message: Message):
    e = await edit_or_reply(message, "Kabhi")
    await e.edit("Fayda")
    await e.edit("Utha")
    await e.edit("Ke")
    await e.edit("Thak")
...
add_command_help(
    ...
    [
        ...
        ["smoon", "To display the moon animation."],
        ["tmoon", "To display moon animation."],
        ["loveu", "To display love animation."],
        ["train", "To display the animation train."],
        ["thinking", "To display the animation thinking."],
        ["villian", "To display a villian animation."],
        ["villian2", "To display the villian3 animation."],
        ["angel", "To display the angel animation."],
        ["villian3", "To display villian3 art."],
        ["fire", "To display fire art with emoji."],
        ["devil", "To display devil art."],
        ["death", "To display death art."],
        ["villian4", "To display villian4 art."],
        ["villian5", "To display art villian5."],
        ["villian6", "to display art villian6."],
        ["villian7", "to display art villian7."],
        ["vilen", "To Display art vilen."],
        ["villian8", "To display art villian8."],
        ["attitude1", "To display art attitude1."],
        ["attitude2", "To display art attitude2."],
        ["attitude3", "To display art attitude3."],
        ["attitude4", "To display art attitude4."],
        ["vbtsvillian", "To display art bts villian."],
        [
            "pat",
            "To get a pat gifs",
        ],
