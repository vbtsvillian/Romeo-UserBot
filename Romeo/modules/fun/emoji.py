...
special_emoji_help = [
    ...
    [".think", "Cycles all the phases of the think emojis."],
    [".lamo", "Cycles all the phases of the lamo emojis."],
    [".nothappy", "Cycles all the phases of the nothappy emojis."],
    [".muah", "Cycles all the phases of the kiss emojis."],
    [".gym", "Cycles all the phases of the gym emojis."],
]
